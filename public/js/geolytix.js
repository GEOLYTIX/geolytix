...
var reader = $('#reader'),
    reader__content = reader.find('.bottom > .content'),
...
footer.find('.privacy_policy').first().click(function(){
    ...
    reader__pdf.show();
    reader.show();
    reader__content.animate({ scrollTop: 0 });
});
...
section_blog.find('.blog__box').click(function(){
    var t = $(this).html();
